...
class RateLimiterSuite extends SparkFunSuite {
  ...
  test("historySumThenTrim() returns numLimit as expected") {
    ...
    assert(rateLimiter.rateLimitHistory(0).rate == 100)
    ...
    {
      rateLimiter.appendRateToHistory(10, 1100)
      rateLimiter.appendRateToHistory(20, 1200)
      rateLimiter.appendRateToHistory(30, 1300)
      rateLimiter.appendRateToHistory(40, 1400)
    ...
    assert(rateLimiter.rateLimitHistory(0).rate == 40)
    ...
    {
      rateLimiter.appendRateToHistory(50, 2100)
    ...
    assert(rateLimiter.rateLimitHistory.length == 1)
    assert(rateLimiter.rateLimitHistory(0).rate == 50)
